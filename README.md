...
- `data/eval/v2/v2.1/adversarial_report.md`: standalone adversarial report for the handcrafted stress-test pack. The normal eval command produces this alongside the standard dataset-eval files by default; pass `--skip-adversarial` only when you want to suppress this extra report.
